...
class_1 = ClassName(class_name='20 Minute HIIT Training',
                    description='This class will burn 12-16\
                    calories per minute through different intervals of \
                    speeds over the 20 min class.',
...
class_1 = ClassName(class_name='Mountain Walk',
                    description='This class will take you on a journey of \
                    inclines as well as different intervals of speeds over\
                    the 30 min class.',
...
class_2 = ClassName(class_name='Beach Stroll',
                    description='This class is designed as a nice cool down \
                     walk increasing the blood flow through the lower body \
...
class_1 = ClassName(
    class_name='Boxing Conditioning',
    description="Boxing Conditioning teaches basic boxing \
            skills and techniques, designed to increase muscular \
            ...
            and core strengthening exercises. You will sweat like crazy\
            , build a rock solid core and burn hundreds of calories.",
    user_id=1, category_id=3)
session.add(class_1)
session.commit()

class_2 = ClassName(
    class_name='Fight Heavy',
    description="Train like a champion with Fight FIT, our one-kind\
            class where you'll learn basic MMA skills with a cardio kick.\
            Fight FIT simulates a real UFC Championship fight with five\
            five-minute rounds,utilizing various equipment such as\
            grappling dummies and hanging bags.\
            A basic class includes cardio calisthenics: punch, kick, knee,\
            and elbowstrikes; sprawls; grounded bags; pummeling the bags;\
            break fall; bag work, and core strengthening exercises.",
    user_id=1, category_id=3)
session.add(class_2)
session.commit()

class_3 = ClassName(
    class_name='Youth Boxing',
    description="mixed-level class focuses on developing students'\
    boxing skills and physical fitness. Donté's original and educational\
    approach to teaching is what makes this class popular with kids\
...
class_1 = ClassName(
    ...
    description="If you enjoy moving and shaking your hips to a Latin beat,\
        ...
        more of a party than a workout! Don’t miss it! Suitable for\
        all levels. Train like a true dancer and enjoy the \
        cardiovascular and body-shaping benefits of a dynamic workout\
        that tones muscles, develops core strength and increases balance.\
        A full dance fitness workout! Dance classes are led by\
...
class_3 = ClassName(
    class_name='Cardio Funk Dance Party',
